...
export const ORDER_TRANSITIONS: Record<OrderStatus, OrderStatus[]> = {
  ...
  processing: ['partially_fulfilled', 'fulfilled', 'refunded', 'disputed'],
  partially_fulfilled: ['processing', 'fulfilled', 'refunded', 'disputed'],
  fulfilled: ['processing', 'partially_fulfilled', 'closed', 'refunded', 'disputed'],
  closed: ['processing', 'partially_fulfilled', 'refunded', 'disputed'],
  cancelled: [],
  refunded: [],
...
export const SHIPMENT_TRANSITIONS: Record<ShipmentStatus, ShipmentStatus[]> = {
  ...
  delivered: ['returned'],
  failed_delivery: ['shipped', 'returned', 'lost'],
  lost: [],
  returned: [],
...
export const BOX_TRANSITIONS: Record<BoxStatus, BoxStatus[]> = {
  ...
  fulfilled: ['on_hold'],
  on_hold: ['paid_unopened', 'fulfillment_pending', 'fulfilled'],
  void: ['reserved'],
}
